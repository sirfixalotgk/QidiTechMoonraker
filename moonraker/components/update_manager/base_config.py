...
BASE_CONFIG: Dict[str, Dict[str, str]] = {
    "moonraker": {
        "origin": "https://github.com/sirfixalotgk/QidiTechMoonraker.git",
        "requirements": "scripts/moonraker-requirements.txt",
        "venv_args": "-p python3",
        "install_script": "scripts/install-moonraker.sh",
        "host_repo": "sirfixalotgk/QidiTechMoonraker",
        "env": sys.executable,
        "path": MOONRAKER_PATH,
        "managed_services": "moonraker"
    },
    "klipper": {
        "moved_origin": "https://github.com/sirfixalotgk/QidiTechKlipper.git",
        "origin": "https://github.com/sirfixalotgk/QidiTechKlipper.git",
